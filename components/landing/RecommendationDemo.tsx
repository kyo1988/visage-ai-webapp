 ...
 */
export function RecommendationDemo({ locale = 'ja' }: RecommendationDemoProps) {
  ...
  useEffect(() => {
    ...
    gaEvent('recommendation_demo_page_viewed', { locale });
  }, []);
  ...
  const fetchRecommendations = useCallback(async () => {
    ...
    try {
      ...
      gaEvent('recommendation_demo_recommendation_fetched', {
        skin_type: skinType,
      ...
      gaEvent('recommendation_demo_error', { error: err.message });
    } finally {
      setLoading(false);
    }
  ...
  const handleMetricChange = (key: string, value: number) => {
    ...
    gaEvent('recommendation_demo_slider_changed', {
      metric: key,
      value,
      skin_type: skinType,
    });
  ...
  const handleSkinTypeChange = (newSkinType: string) => {
    ...
    gaEvent('recommendation_demo_skin_type_changed', {
  ...
  const handleGetRecommendations = () => {
    gaEvent('recommendation_demo_get_recommendations_clicked', {
      skin_type: skinType,
      metrics,
