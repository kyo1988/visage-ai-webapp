      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 md:gap-5 md:grid-cols-3">
          <div className="rounded-xl border bg-white p-4 md:p-5 shadow-sm text-center relative">
            ...
            <h3 className="text-2xl font-bold text-sky-600 mb-2">+20%</h3>
            <p className="text-sm text-muted-foreground mb-4">CVR improvement with XAI insights</p>
          ...
          <div className="rounded-xl border bg-white p-4 md:p-5 shadow-sm text-center relative">
            ...
            <h3 className="text-2xl font-bold text-emerald-600 mb-2">+10pt</h3>
            <p className="text-sm text-muted-foreground mb-4">NPS increase through transparency</p>
            <div className="absolute bottom-3 right-3">
              <a href="#disclaimer" className="text-xs text-muted-foreground hover:underline">*</a>
            </div>
          </div>
          ...
          <div className="rounded-xl border bg-white p-4 md:p-5 shadow-sm text-center relative">
            ...
            <h3 className="text-2xl font-bold text-violet-600 mb-2">+10%</h3>
            <p className="text-sm text-muted-foreground mb-4">LTV growth with retention focus</p>
            <div className="absolute bottom-3 right-3">
              <a href="#disclaimer" className="text-xs text-muted-foreground hover:underline">*</a>
            </div>
          </div>
